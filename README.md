...
- `eventCategory` - Optional event category filter (e.g. `price_surge`, `price_drop`, `regulatory`). Case-insensitive and matched against `eventCategory`. Up to 64 characters.
