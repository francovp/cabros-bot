...
for collection_group in idempotency_keys news-monitor-dedup notificationDeadLetters tradingSignalOutcomes symbolAnalyses chatPreferences; do
...
echo "Done. Firestore will now auto-delete expired documents in idempotency_keys, news-monitor-dedup, notificationDeadLetters, tradingSignalOutcomes, symbolAnalyses, and chatPreferences."
