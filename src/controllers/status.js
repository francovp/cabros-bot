...
const { signalFlipGuard } = require('../services/alerts/signalFlipGuard');
...
function getStatus() {
	...
	return {
		...
		featureFlags: {
			...
			alertFlipGuard: signalFlipGuard.isEnabled(),
		...
		dependencies: {
			...
			alertFlipGuard: {
				enabled: signalFlipGuard.isEnabled(),
				...signalFlipGuard.getStats(),
			},
