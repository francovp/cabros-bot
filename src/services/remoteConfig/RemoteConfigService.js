...
function getEnvironmentConfig() {
	...
	return {
		...
		TRADINGVIEW_MCP_TIMEOUT_MS: parseValue(
			process.env.TRADINGVIEW_MCP_TIMEOUT_MS,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_TIMEOUT_MS,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_TIMEOUT_MS.defaultValue,
		),
		TRADINGVIEW_MCP_MAX_RETRIES: parseValue(
			process.env.TRADINGVIEW_MCP_MAX_RETRIES,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_MAX_RETRIES,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_MAX_RETRIES.defaultValue,
		),
		TRADINGVIEW_MCP_ENRICHMENT_BUDGET_MS: parseValue(
			process.env.TRADINGVIEW_MCP_ENRICHMENT_BUDGET_MS,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_ENRICHMENT_BUDGET_MS,
			PARAMETER_SCHEMA.TRADINGVIEW_MCP_ENRICHMENT_BUDGET_MS.defaultValue,
		),
