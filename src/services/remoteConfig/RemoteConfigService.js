...
const PARAMETER_SCHEMA = Object.freeze({
	...
	WORKER_HEARTBEAT_STALE_MULTIPLIER: { type: 'number', defaultValue: 3, integer: true, min: 1, max: 20 },
	WORKER_HEARTBEAT_ALERT_COOLDOWN_MS: { type: 'number', defaultValue: 1800000, integer: true, min: 1000, max: 86400000 },
	WORKER_HEARTBEAT_CHECK_INTERVAL_MS: { type: 'number', defaultValue: 60000, integer: true, min: 1000, max: 3600000 },
