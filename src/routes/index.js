...
function getRoutes(botOrGetter) {
	...
	router.post('/webhook/alert', maintenanceModeMiddleware, validateApiKey, idempotencyMiddleware, postAlert(botOrGetter));
	router.post('/webhook/message', maintenanceModeMiddleware, validateApiKey, idempotencyMiddleware, postMessage(botOrGetter));
	router.post('/webhook/expanded-analysis-alert', maintenanceModeMiddleware, validateApiKey, idempotencyMiddleware, postExpandedAnalysisAlert(botOrGetter));
	router.post('/webhook/market-scanner-alert', maintenanceModeMiddleware, validateApiKey, idempotencyMiddleware, postMarketScannerAlert(botOrGetter));
	router.post('/webhook/volume-confirmation', maintenanceModeMiddleware, validateApiKey, postVolumeConfirmation());
	router.post('/webhook/symbol-analysis', maintenanceModeMiddleware, validateApiKey, postSymbolAnalysis());
	...
	router.post('/news-monitor', maintenanceModeMiddleware, validateApiKey, newsMonitor.handleRequest.bind(newsMonitor));
	router.get('/news-monitor', maintenanceModeMiddleware, validateApiKey, newsMonitor.handleRequest.bind(newsMonitor));
