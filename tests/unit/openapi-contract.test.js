...
describe('OpenAPI contract', () => {
	...
	it('requires the documented API-key schemes on every protected operation', () => {
		...
		const firebaseAdminOperations = new Set([
			...
			'GET /api/outcomes', 'GET /api/outcomes/summary', 'GET /api/outcomes/export', 'GET /api/outcomes/{outcomeId}',
	...
	it('marks Firebase-backed admin operations with viewer or operator roles', () => {
		...
		const expectedRoles = {
			...
			'GET /api/outcomes/export': 'admin.viewer',
			'GET /api/outcomes/{outcomeId}': 'admin.viewer',
