...
describe('OpenAPI contract', () => {
	...
	it('requires the documented API-key schemes on every protected operation', () => {
		...
		const firebaseAdminOperations = new Set([
			...
			'POST /api/jobs/{jobId}/retry-failed', 'GET /api/outcomes', 'GET /api/outcomes/summary', 'GET /api/trading/binance/orders', 'POST /api/trading/binance/orders', 'DELETE /api/trading/binance/orders', 'GET /api/status', 'GET /api/capabilities', 'GET /api/metrics',
		]);
