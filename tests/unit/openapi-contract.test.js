...
describe('OpenAPI contract', () => {
	...
	it('requires the documented API-key schemes on every protected operation', () => {
		...
		const firebaseAdminOperations = new Set([
			...
			'GET /api/chat-subscriptions', 'POST /api/chat-subscriptions', 'DELETE /api/chat-subscriptions', 'DELETE /api/chat-subscriptions/{subscriptionId}', 'GET /api/chat-subscriptions/status',
		]);
