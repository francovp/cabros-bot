...
describe('OpenAPI contract', () => {
	...
	it('requires the documented API-key schemes on every protected operation', () => {
		...
		const firebaseAdminOperations = new Set([
			...
			'GET /api/trading/binance/orders', 'POST /api/trading/binance/orders',
			'GET /api/trading/binance/pause', 'POST /api/trading/binance/pause',
			'POST /api/trading/binance/resume', 'GET /api/status', 'GET /api/capabilities',
		]);
	...
	it('marks Firebase-backed admin operations with viewer or operator roles', () => {
		...
		const expectedRoles = {
			...
			'GET /api/trading/binance/pause': 'admin.viewer',
			'POST /api/trading/binance/pause': 'admin.operator',
			'POST /api/trading/binance/resume': 'admin.operator',
