...
describe('OpenAPI contract', () => {
	...
	it('requires the documented API-key schemes on every protected operation', () => {
		...
		const firebaseAdminOperations = new Set([
			...
			'POST /api/jobs/{jobId}/retry-failed', 'GET /api/outcomes', 'GET /api/outcomes/summary', 'GET /api/portfolio/snapshot', 'GET /api/trading/binance/orders', 'POST /api/trading/binance/orders', 'DELETE /api/trading/binance/orders', 'GET /api/status', 'GET /api/capabilities',
		]);
	...
	it('marks Firebase-backed admin operations with viewer or operator roles', () => {
		...
		const expectedRoles = {
			...
			'GET /api/portfolio/snapshot': 'admin.viewer',
