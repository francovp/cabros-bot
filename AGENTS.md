...
- `src/controllers/commands.js` — Telegram command handlers wired in `index.js` (`/precio`, `/cryptobot`, `/jobs`, `/history`).
...
- Add the primary command to `src/lib/telegramCommandMenu.js` and the MarkdownV2 help text
